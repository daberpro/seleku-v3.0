...
export const ArrayWatcher = function (array, event)
{
    ...
    return new Proxy(array,
    {
        ...
        {
            if (event instanceof Object && event.hasOwnProperty("watch") && property !== "length" && typeof property !== 'function' && isNaN(parseFloat(property)))
            {
            ...
            {
                if (property !== "length")
                    event.watch(property, "get", target);
            }
